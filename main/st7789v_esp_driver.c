...
int st7789v_esp_driver_init(esp_lcd_panel_io_color_trans_done_cb_t bus_transmission_complete_cb) {
   gpio_config_t rd_gpio_config = {
    ...
    for (uint8_t i = 0; i < (sizeof(st7789v_init_sequence) / sizeof(st7789v_cmd_t)); i++) {
...
void st7789v_esp_driver_draw_bitmap(uint16_t x, uint16_t y, uint16_t width, uint16_t hight, uint16_t *data)
{
